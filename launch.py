...
import train
from birdjepa import benchmark

log_format = "[%(asctime)s] [%(levelname)s] [%(name)s] %(message)s"
logger = logging.getLogger("birdjepa")


def launch_train(cfg: tp.Annotated[train.Config, tyro.conf.arg(name="")]):
    ...
    if cfg.slurm_acct:
        ...
        job = executor.submit(train.worker_fn, cfg)
